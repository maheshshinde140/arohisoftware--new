  ...
  return (
    <div className=' relative h-screen'>
      ...
      <h1 className="pb-2 font-sans font-medium text-lg text-white" style={{ textShadow: '2px 2px 4px rgba(0, 0, 0, 0.5)' }}>
        ...
        <div className=' h-full w-full mt-10 p-8 ' style={{ textShadow: '4px 4px 8px rgba(0, 0, 0, 0.5)' }}>
          <h1 className=' text-[2.5rem] font-mono'>Shaping the Future of Technology</h1>
          <p className='pt-14 text-3xl lg:w-[70%] w-full'>Your vision, our innovation: Building a better world together. </p>
          <button className=' bg-white font-bold  text-black rounded-md p-2 mt-[60px]' >Let&apos;s Connect</button>
        </div>
      </div>

      <div className='w-full bg-slate-100 flex lg:flex-row sm:flex-col lg:justify-between sm:justify-center '>
      <div className=' h-[350px] lg:w-[500px] lg:m-[90px] bg-cover' style={{backgroundImage: `url(https://images.unsplash.com/photo-1542744173-05336fcc7ad4?q=80&w=2002&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)`}} ></div>
      <div className='h-[300] lg:w-[500px] lg:m-[100px] '>
    ...
    <div className='lg:h-[800px] w-full bg-white lg:p-[80px] flex lg:flex-row sm:flex-col lg:justify-between sm:justify-center'>
      ...
      <div className='h-fit lg:h-[600px] lg:w-[500px]'>
    ...
    <div className='lg:h-[800px] w-full bg-white lg:p-[80px] flex lg:flex-row sm:flex-col lg:justify-between sm:justify-center'>
        <div className='  lg:h-[600px] lg:w-[500px]'>
        <h1 className='p-5 font-mono text-4xl text-black'>
        Computing Futures
        </h1>
      ...
      <div className='lg:h-[600px] lg:w-[600px] bg-cover shadow-sm flex-nowrap' style={{backgroundImage: `url(https://images.unsplash.com/photo-1461749280684-dccba630e2f6?q=80&w=2069&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)`}} ></div>
